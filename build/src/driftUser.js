...
export class DriftUser {
    ...
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            const [userAccount] = yield fetchUserAccountsUsingKeys(this.connection, this.driftClient.program, [getDriftUser(this.authority)]);
            if (!userAccount)
